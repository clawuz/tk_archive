...
// Derives search tags from a file's folder path and filename — e.g.
// ".../TKStore/TK_OFFICIAL_STORE_2026/B-Pamuk/Tüm Beyaz Tişört.png" yields
// ['tkstore', 'tk-official-store-2026', 'b-pamuk', 'tüm', 'beyaz', 'tişört'].
// This mirrors how the archive is actually organized (by client/campaign/
// project folder), unlike generic object-detection tags.
function extractAutoTags(fullPath, archiveRoot) {
  const rel = path.relative(archiveRoot, fullPath);
